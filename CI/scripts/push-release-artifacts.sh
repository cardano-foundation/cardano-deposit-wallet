...
artifact() {
	...
	local artifact_value=$(curl -H "Authorization: Bearer $BUILDKITE_API_TOKEN" \
		-X GET "https://api.buildkite.com/v2/organizations/cardano-foundation/pipelines/cardano-deposit-wallet/builds/$main_build/artifacts?per_page=100" |
...
artifact "cardano-deposit-wallet-$VERSION-docker-image.tgz"
