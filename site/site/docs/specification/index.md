...
[cardano-foundation/cardano-wallet-agda](https://github.com/cardano-foundation/cardano-wallet-agda/tree/b5f11bde33585277aa3628b01fe6f5ee8bed2101).
...
* [Specification.Common](./Common.lagda.md)
  — Minor additional Haskell concepts.

In addition, we also need to import concepts that are specific to Cardano:

* [Specification.Cardano](./Cardano.lagda.md)
  * [Specification.Cardano.Chain](./Cardano/Chain.lagda.md)
  — Types `ChainPoint`, `Slot`.
  * [Specification.Cardano.Tx](./Cardano/Tx.lagda.md)
  — Transaction type `Tx`.
  * [Specification.Cardano.Value](./Cardano/Value.lagda.md)
...
* [Specification.Wallet.UTxO](./Wallet/UTxO.lagda.md)
...
[Specification.Wallet.Payment](./Wallet/Payment.lagda.md).
